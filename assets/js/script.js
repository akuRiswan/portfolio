...
function renderCertificate() {
  ...
  containerC.innerHTML = certificate
    .map(
      (p) => `
    <a href="${p.link}" target="" class="certificate-card mt-8 min-w-[80vw] md:min-w-[500px] group relative overflow-hidden rounded-3xl h-[30vh] lg:h-[30vh] bg-gray-100 block z-100">
